return {
	...
	config = function()
		require("gitlab").setup({
			...
			log_path = "/Users/harrisoncramer/Desktop/logfile.txt",
		...
		vim.keymap.set("n", "glm", function()
			require("gitlab").choose_merge_request_by_username({ username = "hcramer1" })
		end, { desc = "Open my MRs" })
	end,
}
